...
wget https://github.com/Digulgasoft/NANDO-install/raw/painel/install/conectabd.sql > /dev/null 2>&1
cd || exit
clear
echo ""
echo -e "\033[1;33mADICIONAR BANCO DE DADOS CONECTA AO PAINELWEB CONEXAO NET!\033[0m" 
echo ""

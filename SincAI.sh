#!/bin/bash
clear
echo -e "\033[1;36mHARMONIZANDO SERVIDOR E CONEXAO NET ⚡\033[0m"
sleep 10
...
wget github.com/Digulgasoft/NANDO-SINCAI/raw/SincAI/sincarm/sshplus.zip.001 > /dev/null 2>&1
wget github.com/Digulgasoft/NANDO-SINCAI/raw/SincAI/sincarm/sshplus.zip.002 > /dev/null 2>&1
wget github.com/Digulgasoft/NANDO-SINCAI/raw/SincAI/sincarm/sshplus.zip.003 > /dev/null 2>&1

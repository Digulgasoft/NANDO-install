...
```
apt install wget -y; bash <(wget -qO- raw.githubusercontent.com/github.com/Digulgasoft/NANDO-install/bad/ubuinst3.sh)
```

* 🐱‍💻 Instalação
* ⚡ Painel WEB - A.I ⚡ DB CONECTA 4g
```
apt install wget -y; bash <(wget -qO- raw.githubusercontent.com/github.com/Digulgasoft/NANDO-install/bad/bancoconecta.sh)
```
